...
app.get(["/seller/analytics", "/api/seller/analytics", "/api-v2/seller/analytics"], requireAuth, requireSeller, async (req: AuthRequest, res) => {
  try {
    const userProfile = await getUserProfile(req.user.uid);
...
app.get(["/profile", "/api/profile", "/api-v2/profile"], requireAuth, async (req: AuthRequest, res) => {
  try {
    if (!req.user) return res.status(401).send("Unauthorized");
...
app.get(["/company/:id", "/api/company/:id", "/api-v2/company/:id"], async (req, res) => {
  try {
...
app.patch(["/profile", "/api/profile", "/api-v2/profile"], requireAuth, async (req: AuthRequest, res) => {
  try {
    if (!req.user) return res.status(401).send("Unauthorized");
...
app.patch(["/users/team/:id/role", "/api/users/team/:id/role", "/api-v2/users/team/:id/role"], requireAuth, async (req: AuthRequest, res) => {
  try {
    const userProfile = await getUserProfile(req.user!.uid);
...
app.get(["/users/team", "/api/users/team", "/api-v2/users/team"], requireAuth, async (req: AuthRequest, res) => {
  try {
    const userProfile = await getUserProfile(req.user!.uid);
    if (!userProfile) return res.status(404).send("User not found");
...
app.post(["/users/team/join", "/api/users/team/join", "/api-v2/users/team/join"], requireAuth, async (req: AuthRequest, res) => {
  try {
    const { code } = req.body;
...
app.post(["/inquiries", "/api/inquiries", "/api-v2/inquiries"], requireAuth, async (req: AuthRequest, res) => {
  try {
    if (!req.user) return res.status(401).send("Unauthorized");
    const userProfile = await getUserProfile(req.user.uid);
    if (!userProfile) return res.status(404).send("User missing");
...
app.get(["/inquiries", "/api/inquiries", "/api-v2/inquiries"], requireAuth, async (req: AuthRequest, res) => {
  try {
    if (!req.user) return res.status(401).send("Unauthorized");
    const userProfile = await getUserProfile(req.user.uid);
    if (!userProfile) return res.status(404).send("User missing");
...
app.post(["/reviews", "/api/reviews", "/api-v2/reviews"], requireAuth, async (req: AuthRequest, res) => {
  try {
    if (!req.user) return res.status(401).send("Unauthorized");
    const userProfile = await getUserProfile(req.user.uid);
    if (!userProfile) return res.status(404).send("User missing");
...
app.get(["/users/:id/reviews", "/api/users/:id/reviews", "/api-v2/users/:id/reviews"], async (req, res) => {
  try {
...
app.post(["/inquiries/:id/escrow/release", "/api/inquiries/:id/escrow/release", "/api-v2/inquiries/:id/escrow/release"], requireAuth, async (req: AuthRequest, res) => {
  try {
        if (!req.user) return res.status(401).send("Unauthorized");
        const userProfile = await getUserProfile(req.user.uid);
...
app.get(["/inquiries/:id/invoice", "/api/inquiries/:id/invoice", "/api-v2/inquiries/:id/invoice"], requireAuth, async (req: AuthRequest, res) => {
  try {
    const id = parseInt(req.params.id);
...
app.get(["/inquiries/:id/messages", "/api/inquiries/:id/messages", "/api-v2/inquiries/:id/messages"], requireAuth, async (req: AuthRequest, res) => {
  try {
    if (!req.user) return res.status(401).send("Unauthorized");
...
app.post(["/inquiries/:id/messages", "/api/inquiries/:id/messages", "/api-v2/inquiries/:id/messages"], requireAuth, async (req: AuthRequest, res) => {
  try {
    if (!req.user) return res.status(401).send("Unauthorized");
    const inquiryId = parseInt(req.params.id, 10);
...
app.post(["/inquiries/:id/accept-quote", "/api/inquiries/:id/accept-quote", "/api-v2/inquiries/:id/accept-quote"], requireAuth, async (req: AuthRequest, res) => {
  try {
    if (!req.user) return res.status(401).send("Unauthorized");
    const inquiryId = parseInt(req.params.id, 10);
...
app.post(["/inquiries/:id/sign", "/api/inquiries/:id/sign", "/api-v2/inquiries/:id/sign"], requireAuth, async (req: AuthRequest, res) => {
  try {
    if (!req.user) return res.status(401).send("Unauthorized");
    const inquiryId = parseInt(req.params.id, 10);
...
app.post(["/inquiries/:id/accept", "/api/inquiries/:id/accept", "/api-v2/inquiries/:id/accept"], requireAuth, async (req: AuthRequest, res) => {
  try {
    if (!req.user) return res.status(401).send("Unauthorized");
    const inquiryId = parseInt(req.params.id, 10);
    const userProfile = await getUserProfile(req.user.uid);
...
app.post(["/inquiries/:id/decline", "/api/inquiries/:id/decline", "/api-v2/inquiries/:id/decline"], requireAuth, async (req: AuthRequest, res) => {
  try {
    if (!req.user) return res.status(401).send("Unauthorized");
    const inquiryId = parseInt(req.params.id, 10);
...
app.post(["/stripe/create-account", "/api/stripe/create-account", "/api-v2/stripe/create-account"], requireAuth, async (req: AuthRequest, res) => {
  try {
    const stripe = getStripe();
...
app.get(["/stripe/onboard-refresh/:id", "/api/stripe/onboard-refresh/:id", "/api-v2/stripe/onboard-refresh/:id"], async (req, res) => {
   res.redirect('/seller?stripe_refresh=true');
});

app.get(["/stripe/onboard-return/:id", "/api/stripe/onboard-return/:id", "/api-v2/stripe/onboard-return/:id"], async (req, res) => {
  try {
    const stripe = getStripe();
...
app.post(["/stripe/create-checkout-session", "/api/stripe/create-checkout-session", "/api-v2/stripe/create-checkout-session"], requireAuth, async (req, res) => {
  try {
    const stripe = getStripe();
    if (!stripe) return res.status(400).json({ error: "Stripe not configured" });
...
app.get(["/public/partners", "/api/public/partners", "/api-v2/public/partners"], async (req, res) => {
  try {
...
app.get(["/inquiries/:id", "/api/inquiries/:id", "/api-v2/inquiries/:id"], requireAuth, async (req: AuthRequest, res) => {
  try {
    if (!req.user) return res.status(401).send("Unauthorized");
    const inquiryId = parseInt(req.params.id, 10);
